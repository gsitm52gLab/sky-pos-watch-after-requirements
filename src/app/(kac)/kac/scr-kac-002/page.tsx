...
const detailCols = ["순번","자산번호","자산내역","자산구분","무상여부","임대료산정","사용목적","면적","단가","신청시작일","신청종료일"];

export default function ScrKac002() {
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-2">
        ...
        <button className="rounded border border-[#d6e0ea] bg-white px-3 py-1.5 text-[12px] text-[#475569] hover:bg-[#f8fbff]">변경</button>
          ...
          <div className="rounded-[18px] border border-[#d7e2ee] bg-white shadow-[0_10px_24px_rgba(15,23,42,0.04)]">
            ...
            <div className="px-5 py-4 space-y-3 text-sm">
              ...
              <div className="grid grid-cols-2 gap-x-6 gap-y-2 md:grid-cols-4">
                ...
                <div><span className="text-[11px] font-semibold text-[#64748b] block mb-1">계약번호</span><Input value="0000040993" readOnly className="h-7 border-[#d6e0ea] text-sm bg-[#f8fbff]" /></div>
                <div><span className="text-[11px] font-semibold text-[#64748b] block mb-1">계약 차수</span><Input value="00" readOnly className="h-7 border-[#d6e0ea] text-sm bg-[#f8fbff]" /></div>
                <div><span className="text-[11px] font-semibold text-[#64748b] block mb-1">상태</span><Input value="가계약" readOnly className="h-7 border-[#d6e0ea] text-sm bg-[#f8fbff]" /></div>
              </div>
              <div className="grid grid-cols-2 gap-x-6 gap-y-2 md:grid-cols-4">
                ...
                <div className="flex items-end gap-2"><div className="flex-1"><span className="text-[11px] font-semibold text-[#64748b] block mb-1">상업부대시설</span><input type="checkbox" className="mt-2" /></div></div>
              ...
              <div className="grid grid-cols-2 gap-x-6 gap-y-2 md:grid-cols-4">
                <div><span className="text-[11px] font-semibold text-[#64748b] block mb-1">고객코드</span><Input className="h-7 border-[#d6e0ea] text-sm" /></div>
