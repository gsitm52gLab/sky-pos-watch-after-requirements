...
export default function ScrKac003() {
  const rows = [
    { 사업영역: "BA15", 계약번호: "40594", 계약차수: "0", 계약상태: "가계약", 용도구분: "업무시설", 고객코드: "S40785", 상로명: "", 고객명: "에이케이아이에스 주식회사", 생성일자: "2025.12.26" },
    { 사업영역: "BA15", 계약번호: "40900", 계약차수: "0", 계약상태: "가계약", 용도구분: "업무시설", 고객코드: "S10030", 상로명: "", 고객명: "(주)대한팔공", 생성일자: "2026.03.13" },
    { 사업영역: "BA15", 계약번호: "40966", 계약차수: "0", 계약상태: "가계약", 용도구분: "업무시설", 고객코드: "S10030", 상로명: "", 고객명: "(주)대한팔공", 생성일자: "2026.04.03" },
  ];

  const cols = ["사업영역","계약번호","계약차수","계약상태","용도구분","고객코드","상로명","고객명","생성일자"];
