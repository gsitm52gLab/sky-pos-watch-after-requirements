...
export const kacMenu: MenuItem[] = [
  {
    id: "kac-1", label: "임대계약관리", area: "kac", icon: "📄", children: [
      ...
      { id: "SCR-KAC-004", label: "계약마스터 생성 (입력조건)", path: "/kac/scr-kac-004", area: "kac" },
      { id: "SCR-KAC-005", label: "계약마스터 생성 (본계약)", path: "/kac/scr-kac-005", area: "kac" },
      ...
      { id: "SCR-KAC-029", label: "신청기간만료 90일 조회", area: "kac" },
      { id: "SCR-KAC-030", label: "임대계약 자산번호관리", area: "kac" },
      { id: "SCR-KAC-031", label: "임대계약 현황판조회", area: "kac" },
      { id: "SCR-KAC-032", label: "임대계약 차기년도 이관", area: "kac" },
    ],
  },
  {
    id: "kac-2", label: "계약처리", area: "kac", icon: "✍️", children: [
      ...
      { id: "SCR-KAC-033", label: "연고지 과거일 중도해지 (일부임대물건)", area: "kac" },
      ...
      { id: "SCR-KAC-034", label: "전자계약 대량생성", area: "kac" },
      { id: "SCR-KAC-035", label: "전자계약 상태관리", area: "kac" },
      { id: "SCR-KAC-036", label: "임대계약별 중도해지 현황", area: "kac" },
    ],
  },
  {
    id: "kac-3", label: "임대료/추가임대료", area: "kac", icon: "💰", children: [
      ...
      { id: "SCR-KAC-037", label: "임대료 사용내역 조회", area: "kac" },
      { id: "SCR-KAC-038", label: "임대료 감면액 조회", area: "kac" },
      { id: "SCR-KAC-039", label: "임대료 전송실적 모니터링", area: "kac" },
      { id: "SCR-KAC-040", label: "퇴고지 임대료 전송", area: "kac" },
      { id: "SCR-KAC-041", label: "연도별 업종별 임대료 및 단가 조회", area: "kac" },
    ],
  },
  {
    id: "kac-4", label: "임대현황 조회", area: "kac", icon: "📊", children: [
      ...
      { id: "SCR-KAC-042", label: "임대현황 기준일자 조회", area: "kac" },
      { id: "SCR-KAC-043", label: "임대현황 조회기간", area: "kac" },
      { id: "SCR-KAC-044", label: "업종별 공항별 입주업체 현황", area: "kac" },
      { id: "SCR-KAC-045", label: "업종별 청사별 임대현황", area: "kac" },
      { id: "SCR-KAC-046", label: "임대계약 명세서", area: "kac" },
      { id: "SCR-KAC-047", label: "임대계약 총괄표 (계약번호기준)", area: "kac" },
      { id: "SCR-KAC-048", label: "임대계약 총괄표 (계약순번임대물건기준)", area: "kac" },
      { id: "SCR-KAC-049", label: "임대계약 총괄표 (고객코드기준)", area: "kac" },
      { id: "SCR-KAC-050", label: "추가임대료 종괄표", area: "kac" },
      { id: "SCR-KAC-051", label: "FI 임대보증금 국내국제 조회", area: "kac" },
      { id: "SCR-KAC-052", label: "FI 임대수익 국내국제 조회", area: "kac" },
      { id: "SCR-KAC-053", label: "SD 사용료 추적관리", area: "kac" },
    ],
  },
  {
    id: "kac-5", label: "고객관리", area: "kac", icon: "👥", children: [
      ...
      { id: "SCR-KAC-054", label: "임차업체 연락망관리", area: "kac" },
      { id: "SCR-KAC-055", label: "종합평가점수 등록 및 조회", area: "kac" },
    ],
  },
  {
    id: "kac-6", label: "임대보증금 관리", area: "kac", icon: "🏦", children: [
      ...
      { id: "SCR-KAC-056", label: "임대계약보증금현황 보증금상세내역", area: "kac" },
    ],
  },
];
